...
class CustomResponseCode(CustomCodeBase):
    """Пользовательские коды состояния ответа"""

    HTTP_200 = (200, "Запрос выполнен успешно")
    HTTP_201 = (201, "Новый запрос был выполнен успешно")
    HTTP_202 = (202, "Запрос был принят, но обработка еще не завершена")
    HTTP_204 = (204, "Запрос был выполнен успешно, но содержимое не было возвращено")
    HTTP_400 = (400, "Ошибка запроса")
    HTTP_401 = (401, "Неавторизованный")
    HTTP_403 = (403, "Доступ запрещен")
    HTTP_404 = (404, "Запрошенный ресурс не существует")
    HTTP_410 = (410, "Запрошенный ресурс был удален безвозвратно")
    HTTP_422 = (422, "Параметр запроса является недопустимым")
    HTTP_425 = (
        425,
        "Запрос не удалось выполнить, так как сервер не смог выполнить требования",
    )
    HTTP_429 = (429, "Слишком много запросов, ограничения сервера")
    HTTP_500 = (500, "Внутренняя ошибка сервера")
    HTTP_502 = (502, "Ошибка шлюза")
    HTTP_503 = (503, "Сервер временно не может обработать запрос")
    HTTP_504 = (504, "Тайм-аут шлюза")


class CustomErrorCode(CustomCodeBase):
    """Пользовательский код состояния ошибки"""

    CAPTCHA_ERROR = (40001, "Ошибка в проверочном коде")
    BITRIX_ERROR = (40002, "Ошибка создания smart процесса")
...
class StandardResponseCode:
    """Стандартный код состояния ответа"""
